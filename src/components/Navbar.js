    ...
    <>
      <div className="flex justify-between md:justify-start md:flex-col items-center w-full h-full py-4 shadow-xl">
        <img
          ...
          alt=""
        />
        <div className="flex w-full justify-around md:w-auto md:flex-col">
          <NavLink
            exact
            to="/prototype/"
            activeClassName="bg-red-300 text-white"
            className="flex lg:w-36 gap-2 m-3 px-4 py-2 transition-all rounded-lg font-bold cursor-pointer hover:bg-red-300 hover:text-white hover:font-bold"
          >
          ...
          <Popup
            trigger={
              <button>
                <div className="flex lg:w-36 gap-2 m-3 px-4 py-2 transition-all rounded-lg font-bold cursor-pointer hover:bg-red-300 hover:text-white hover:font-bold">
                  <ion-icon name="home"></ion-icon>
